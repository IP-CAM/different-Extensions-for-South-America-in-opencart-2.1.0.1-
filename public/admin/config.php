<?php
// HTTP
define('HTTP_SERVER', 'http://demo.lojavirtual.digital/admin/');
define('HTTP_CATALOG', 'http://demo.lojavirtual.digital/');

// HTTPS
define('HTTPS_SERVER', 'http://demo.lojavirtual.digital/admin/');
